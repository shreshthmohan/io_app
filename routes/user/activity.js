...
exports.redir = function(req, res) {
  ...
  .success(function(tag) {
    res.redirect(301, '/activity/' + tag.id + '/' + tag.tag_name_slug)
  })
}
...
exports.check = function(req, res) {
  ...
  .success(function(tag) {
    if (req.param('tag_name_slug') == tag.tag_name_slug) {
      render_page(tag, req, res)
    }
    else {
      res.redirect(301, '/activity/' + tag.id + '/' + tag.tag_name_slug)
    }
...
var render_page = function(tag, req, res) {
    db.City.findAll()
    .then(function(cities) {
      var promises = []
      var city
