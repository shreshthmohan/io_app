  ...
  .then(function(tags_c) {
    ...
    .then(function(cities_c) {
      res.render('user/index', {
        active_tab: 'home',
        title_: 'Adventure Outdoors - Running, Cycling, Trekking, Surfing, Kayaking, Rafting, Slacklining, Skateboarding ...',
        cities: cities_c,
        tags: tags_c
      })
    })
...
exports.index_alt = function(req, res) {
  db.Tag.findAll()
  .then(function(tags) {
    var promises = [] // array to be filled with function calls
    var tag
